        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form action="{{route('coupon.update',$edit_coupons->id)}}" method="post" class="form-horizontal">
                    ...
                    <div class="control-group">
                        <label for="amount" class="control-label">Lượng giảm giá</label>
                    ...
                    <div class="control-group">
                        <label for="amount_type" class="control-label">Kiểu giảm giá</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success">Update Mã giảm giá</button>
                        </div>
                    </div>
                </form>
            </div>
